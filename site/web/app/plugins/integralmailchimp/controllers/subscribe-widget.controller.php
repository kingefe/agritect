...
//- Register the widget. WP's Widget class automatically instantiates an instance of any registered widget
add_action('widgets_init', array('IMC\Controllers\Subscribe_Widget_Controller', 'register_widget'));
