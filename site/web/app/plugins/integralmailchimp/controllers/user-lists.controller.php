...
SCRIPT;
        ...
        public static function get_syncable_mergetags($tags) {
            ...
            $tags['SOURCE'] = array(
                'name' => __('Source Page', 'integral-mailchimp'),
                'field_type' => 'text',
                'plugin_name' => 'WordPress',
                'public' => FALSE,
                'show' => FALSE
        ...
        public static function get_mergetag_values_for_sync($tags, $user) {
            ...
            global $wpdb;
            $tags['FNAME']     = isset($user_meta['first_name']) ? reset($user_meta['first_name']) : '';
            $tags['LNAME']     = isset($user_meta['last_name']) ? reset($user_meta['last_name']) : '';
            $tags['NICKNAME']  = isset($user_meta['nickname']) ? reset($user_meta['nickname']) : '';
            $tags['SOURCE'] = isset($user_meta['imc_source_page']) ? reset($user_meta['imc_source_page']) : '';
