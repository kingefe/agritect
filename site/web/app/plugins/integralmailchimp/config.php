...
use IMC\Controllers\Email_Campaigns_CPT_Controller;
...
if (!class_exists('I_Conf')) {
	...
	const UNDERSCORES_TEMPLATE_PATH = 'js/templates/';
         ...
         * 
         * Called directly from the Main Plugin Class (Integral_MailChimp) 
         */
        ...
        public static function register_user_hooks() {
           ...
           //- Support for BuddyPress xprofile fields
           if(defined( 'BP_VERSION' )){
              // add_action( 'xprofile_updated_profile', $bp->displayed_user->id, $posted_field_ids, $errors );
           }
        ...
        public static function register_general_admin_scripts($hook) {
            ...
            wp_register_script('imc-bootstrap-datepicker', plugins_url('js/bootstrap-datepicker.min.js', __FILE__), array('jquery'), NULL, FALSE);

            //- Load unminified js files for debugging
            ...
            wp_register_script('imc-new-email', plugins_url('js/integral-mailchimp-new-email' . $suffix . '.js', __FILE__), array('jquery', 'jquery-effects-slide', 'jquery-effects-core', 'wp-util'), true);
		...
		case 'post-new.php':
			...
			wp_localize_script( 'imc-new-email', 'imc_insert_post_types_array', Email_Campaigns_CPT_Controller::fetch_all_post_types_as_array() );
                        wp_localize_script( 'imc-new-email', 'imc_insert_post_array', Email_Campaigns_CPT_Controller::fetch_all_posts_as_array() );
                        wp_localize_script( 'imc-new-email', 'imc_insert_post_categories_array', Email_Campaigns_CPT_Controller::fetch_post_taxonomies_as_array( 'post' ) );
			wp_localize_script( 'imc-new-email', 'i18n', array(
				'post_type' => __( 'Post Type', 'integral-mailchimp' ),
				'post_category' => __( 'Post Category', 'integral-mailchimp' ),
				'post_select' => __( 'Post Select', 'integral-mailchimp' ),
				'post_search' => __( 'Post Search', 'integral-mailchimp' )
			    ) );
                    }
        ...
        public static function register_general_admin_styles($hook) {
            ...
            //- Load unminified css files for debugging
            if (defined('SCRIPT_DEBUG')) {
                $suffix = '';
            } else {
                $suffix = '.min';
