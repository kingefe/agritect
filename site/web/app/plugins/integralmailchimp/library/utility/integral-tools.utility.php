...
if (!class_exists('I_Tools')) {
	...
	/**
         * Load the requested underscores javascript templates
         * 
         * @param array $utilities
         */
        public static function load_underscores_templates( $templates ) {
            if ( $templates ) {
                $teampltes = (array) $templates;
            } else {
		...
		foreach ( $templates as $template ) {
		    $file_path = IMC_PLUGIN_PATH . I_Conf::UNDERSCORES_TEMPLATE_PATH . $template . '.tpl.php';
		    I_Conf::include_file($file_path);
		}
	    }
