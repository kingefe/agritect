...
<form method="post">
    ...
    <div class="pms-setup-pages">
        ...
        <div class="pms-setup-gateway pms-setup-fade">
            ...
            <div class="pms-setup-gateway__description"><?php _e( 'Allow users to pay using credit or debit cards directly on your website through PayPal Pro.', 'paid-member-subscriptions' ); ?></div>
            <div class="pms-setup-toggle">
