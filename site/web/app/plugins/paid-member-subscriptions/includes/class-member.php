...
Class PMS_Member {
    ...
    public function get_subscriptions() {
        ...
        $subscriptions = $wpdb->get_results( "SELECT id, subscription_plan_id, start_date, expiration_date, status, payment_profile_id FROM {$wpdb->prefix}pms_member_subscriptions WHERE user_id = $this->user_id", ARRAY_A );
