...
if ( ! defined( 'ABSPATH' ) ) exit;
    ...
    $email_value = isset( $_POST['user_login'] ) ? esc_attr( $_POST['user_email'] ) : '';
    $email_value = apply_filters( 'pms_' . $form_name . '_form_value_user_email', $email_value );
?>
...
<form id="pms_<?php echo $form_name; ?>-form" class="pms-form" method="POST">
    ...
    <ul class="pms-form-fields-wrapper">
        ...
        <li class="pms-field pms-user-email-field <?php echo ( !empty( $field_errors ) ? 'pms-field-error' : '' ); ?>">
            ...
            <input id="pms_user_email" name="user_email" type="text" value="<?php echo $email_value; ?>" <?php echo apply_filters( 'pms_register_form_attributes_user_email', '' ); ?>/>
