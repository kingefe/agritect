...
<?php __("Check out the new <strong>Group Memberships</strong> add-on which allows you to sell subscriptions to groups of users managed by a single one (for a company, family etc.)", "paid-member-subscriptions"); ?>
