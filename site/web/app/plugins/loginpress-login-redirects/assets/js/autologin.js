  ...
  $(function() {
    ...
    $(document).on( "click", ".loginpress-user-redirects-update", function(event) {
      ...
      $.ajax({
        ...
        url : ajaxurl,
        type: 'POST',
        data: 'login=' + login + '&logout=' + logout + '&id=' + id + '&action=loginpress_login_redirects_update' +
              '&security=' + _nonce,
        beforeSend: function() {
    ...
    $(document).on( "click", ".loginpress-user-redirects-delete", function(event) {
      ...
      $.ajax({
        ...
        url : ajaxurl,
        type: 'POST',
        data: 'id=' + id + '&action=loginpress_login_redirects_delete' + '&security=' + _nonce,
        beforeSend: function() {
    ...
    $(document).on( "click", ".loginpress-redirects-role-update", function(event) {
      ...
      $.ajax({
        ...
        url : ajaxurl,
        type: 'POST',
        data: 'login=' + login + '&logout=' + logout + '&role=' + role + '&action=loginpress_login_redirects_role_update' + '&security=' + _nonce,
        beforeSend: function() {
          tr.find( '.autologin-sniper' ).show();
    ...
    $(document).on( "click", ".loginpress-redirects-role-delete", function(event) {
      ...
      $.ajax({
        ...
        url : ajaxurl,
        type: 'POST',
        data: 'role=' + role + '&action=loginpress_login_redirects_role_delete' + '&security=' + _nonce,
        beforeSend: function() {
          tr.find( '.loginpress_autologin_code p' ).html('');
          tr.find( '.autologin-sniper' ).show();
          tr.find( '.loginpress-redirects-role-update' ).attr( "disabled", "disabled" );
