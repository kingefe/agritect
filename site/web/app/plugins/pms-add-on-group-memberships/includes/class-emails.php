...
Class PMS_GM_Emails {
    ...
    public function __construct(){
        ...
        add_filter( 'pms_merge_tag_site_name',          array( $this, 'site_name' ) );
        add_filter( 'pms_merge_tag_site_url',           array( $this, 'site_url' ) );
    }
    ...
    public function add_extra_tags( $available_tags ){
        $extra_tags = apply_filters( 'pms_gm_merge_tags', array( 'owner_email', 'invited_user_email', 'invite_link', 'invite_url', 'site_name', 'site_url' ) );
    ...
    public function invite_url( $value, $extra_info, $plan_id ){
        ...
        return add_query_arg( array(
            'email'           => $extra_info['invited_email'],
