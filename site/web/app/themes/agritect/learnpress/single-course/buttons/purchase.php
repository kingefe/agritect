...
<?php do_action( 'learn-press/before-purchase-form' ); ?>
    ...
    <form name="purchase-course" class="purchase-course" method="post" enctype="multipart/form-data">
        ...
        <button class="lp-button button button-purchase-course payment">
			<?php echo esc_html( apply_filters( 'learn-press/purchase-course-button-text', __( 'PAYMENT', 'learnpress' ) ) ); ?>
        </button>
